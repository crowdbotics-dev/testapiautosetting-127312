...
## Project Structure
    ...
    ├── testapiautosetting_127312  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127312`
...
2. Clone this repo and `cd testapiautosetting_127312`
